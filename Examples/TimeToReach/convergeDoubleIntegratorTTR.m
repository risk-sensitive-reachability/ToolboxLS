% convergeDoubleIntegratorTTR: demonstrate double integrator convergence.
%
...
%   the distribution.
%
% Ian Mitchell, 12/05/04

% Numerical and analytic solution generator.
numeric = @doubleIntegratorTTR;
...
for res = 1 : length(resolution),
  ...
  for acc = 1 : length(accuracy),
    ...
    % Get the numeric and analytic solutions.
    [ nttr, attr ] = feval(numeric, accuracy{acc}, g);
